...
public class Quiz {
	...
	private void prepareGUI() {
		...
		// A series of panels on which will rotate and show questions and
		// answers
		...
		for (int i = 0; i < arrayLabels.length; i++) {
			...
			case 3:
				arrayLabels[i]
						.setText("In which the film except \"Pretty Women\" acters are Julia Roberts and Richard Gere");
				break;
			case 4:
		...
		btn2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (arrayRButtons[1].isSelected() || arrayRButtons[5].isSelected() || arrayRButtons[11].isSelected()
						|| arrayRButtons[13].isSelected() || arrayRButtons[16].isSelected()
						|| arrayRButtons[23].isSelected() || arrayRButtons[27].isSelected()
						|| arrayRButtons[29].isSelected() || arrayRButtons[32].isSelected()) {
					s += 10;
				...
				} else if (arrayRButtons[33].isSelected() || arrayRButtons[34].isSelected()
